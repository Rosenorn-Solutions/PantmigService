...
public class ValidationServicesTests
{
    ...
    public void ValidateCreate_Fails_When_TitleMissing()
    {
        ...
        var res = _listingValidator.ValidateCreate(null, null, "City", "asd", from, to, null, null, new());
    ...
    public void ValidateCreate_Allows_Empty_Description()
    {
        ...
        var res = _listingValidator.ValidateCreate("Title", null, "City", "asd", from, to, null, null, items);
    ...
    public void ValidateCreate_Fails_When_Dates_Invalid()
    {
        ...
        var res = _listingValidator.ValidateCreate("Title", "Desc", "City", "asd", from, to, null, null, []);
        Assert.False(res.IsValid);
    ...
    public void ValidateCreate_Fails_When_No_Items()
    {
        var from = DateOnly.FromDateTime(DateTime.UtcNow.Date);
        var to = from.AddDays(1);
        var res = _listingValidator.ValidateCreate("T", "D", "City", "asd", from, to, null, null, new());
        Assert.False(res.IsValid);
    ...
    public void ValidateCreate_Fails_When_Item_Quantity_Invalid()
    {
        ...
        var res = _listingValidator.ValidateCreate("T", "D", "City", "asd", from, to, null, null, items);
        Assert.False(res.IsValid);
    ...
    public void ValidateCreate_Fails_When_Only_One_Coordinate_Provided()
    {
        ...
        var to = from.AddDays(1);
        var items = new List<CreateListingItemInput> { new(RecycleMaterialType.Can, 1, null, null) };
        var res = _listingValidator.ValidateCreate("T", "D", "City", "asd", from, to, 55.0m, null, items);
        Assert.False(res.IsValid);
    ...
    public void ValidateCreate_Fails_When_Coordinates_Out_Of_Range()
    {
        ...
        var to = from.AddDays(1);
        var items = new List<CreateListingItemInput> { new(RecycleMaterialType.Can, 1, null, null) };
        var resLat = _listingValidator.ValidateCreate("T", "D", "City", "asd", from, to, 100m, 10m, items);
        Assert.False(resLat.IsValid);
        var resLon = _listingValidator.ValidateCreate("T", "D", "City", "asd", from, to, 10m, 200m, items);
    ...
    public void ValidateCreate_Succeeds_With_Valid_Coordinates()
    {
        ...
        var to = from.AddDays(1);
        var items = new List<CreateListingItemInput> { new(RecycleMaterialType.Can, 1, null, null) };
        var res = _listingValidator.ValidateCreate("T", "D", "City", "asd", from, to, 55.6761m, 12.5683m, items);
        Assert.True(res.IsValid);
